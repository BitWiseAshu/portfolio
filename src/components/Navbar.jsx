...
const Navbar = () => {
    ...
    return (
        <header className='sticky opacity-100'>
            <div className='container flex justify-between items-center p-[1rem]'>
                <div className='left'>
                    ...
                    <nav>
                        <ul className="bg-white shadow-lg ">
                            <div className='flex items-center justify-center mr-[8rem]'>
                                ...
                                <li className='block py-2 px-4 text-[#3a1616] hover:text-navbarColor hover:underline font-serif cursor-pointer'><NavLink to="/" onClick={toggleNavbar}>Home</NavLink></li>
                            </div>

                            <div className='flex items-center justify-center mr-[8rem]'>
                                <FontAwesomeIcon icon={faAddressCard} style={{ color: "#FFD43B" }} size='x' />
                                <li className='block py-2 px-4 text-[#3a1616] hover:text-navbarColor hover:underline font-serif cursor-pointer'><NavLink to="/about" onClick={toggleNavbar}>About</NavLink></li>
                            </div>

                            <div className='flex items-center justify-center mr-[8rem]'>
                                <FontAwesomeIcon icon={faDiagramProject} style={{ color: "#FFD43B" }} size='x' />
                                <li className='block py-2 px-2 text-[#3a1616] hover:text-navbarColor hover:underline font-serif cursor-pointer'><NavLink to="/projects" onClick={toggleNavbar}>Projects</NavLink></li>
                            </div>

                            <div className='flex items-center justify-center mr-[8rem]'>
                                <FontAwesomeIcon icon={faAddressBook} style={{ color: "#FFD43B" }} size="x" />
                                <li className='block py-2 px-3 text-[#3a1616] hover:text-navbarColor hover:underline font-serif cursor-pointer'><NavLink to="/contact" onClick={toggleNavbar}>Contact</NavLink></li>
                            </div>
                        </ul>
                    </nav>
                </div>
