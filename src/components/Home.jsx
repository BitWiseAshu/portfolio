    ...
    <>
      <div className='flex m-[2rem] justify-around md:gap-[2rem] lg:gap-0 max-[767px]:flex-col-reverse max-[767px]:w-[25rem] max-[767px]:m-0 max-[767px]:p-[2rem] max-[400px]:w-[20rem] max-[350px]:w-[18rem]'>
        <div className='left flex flex-col gap-[20px] lg:w-[30rem] lg:mr-[20rem] md:w-[22rem] font-serif max-[767px]:w-[22rem] max-[400px]:w-[18rem]'>
          <p className='font-bold text-[2rem] max-[430px]:text-[1.5rem] max-[500px]:mt-[1.5rem]'>Hello It's Me</p>
          <p className='font-extrabold text-[2.2rem] max-[430px]:text-[1.5rem]'>Om Nath Dixit</p>
          <p className='font-bold text-[2rem] max-[430px]:text-[1.6rem]'>And I am a <span className='text-[blue] '>Web Developer</span></p>
          <p className='text-justify mt-[3rem] max-[350px]:pr-[1rem] '>Hey there! I'm Om Nath Dixit, a driven student of Computer Science with a deep passion for web development. As I navigate through my academic journey, I'm continually refining my skills and exploring the ever-evolving landscape of web technologies.</p>
          {/* Wrap the button with Link */} 

          <div className='space-x-10 flex xl:flex-row lg:flex-col xl:gap-0 md:gap-2 md:flex-col max-[767px]:flex-col max-[767px]:gap-3 '>
            <Link to='/contact'>
              ...
              <button className="group relative inline-flex text-[1.2rem] items-center justify-start p-[0.5rem] overflow-hidden  bg-indigo-50 py-3 pl-6 pr-16 font-semibold text-indigo-600 transition-all duration-150 ease-in-out hover:pl-16 hover:pr-6 hover:bg-[#6b61de] bg-[#7b5ebd] rounded-xl">
                ...
                <span className="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-[#af9b9b]">Contact Us</span>
              </button>
            </Link>
        ...
        <div className='right w-[20rem] xl:w-[20rem] lg:w-[22rem] md:w-[16rem] max-[767px]:w-[20rem] max-[350px]:w-[15rem] max-[400px]:w-[18rem]'>
          <img src={maleImg} alt="developer" className='rounded-xl md:ml-[5rem]  lg:ml-0 lg:pr-[1rem]'/>
        </div>
      </div>
    </>
  )
